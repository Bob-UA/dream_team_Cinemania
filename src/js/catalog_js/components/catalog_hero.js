  ...
  return `
   <h1 class="text-modal-oops">
    ...
    <picture class="camera">
      <source srcset="./public/modal_oops_img/modal-camera-mobile-1x.jpg 1x, ./public/modal_oops_img/modal-camera-mobile-2x.jpg 2x" media="(max-width: 767px)" />
      <source srcset="./public/modal_oops_img/modal-camera-tablet-1x.jpg 1x, ./public/modal_oops_img/modal-camera-tablet-2x.jpg 2x" media="(min-width: 768px and max-width: 1279px)" />
      <source srcset="./public/modal_oops_img/modal-camera-desktop-1x.jpg 1x, ./public/modal_oops_img/modal-camera-desktop-2x.jpg 2x" media="(min-width: 1280px)" />
      <img src="./public/modal_oops_img/modal-camera-mobile-1x.jpg" alt="camera" />
    </picture>
  </div>`;
}

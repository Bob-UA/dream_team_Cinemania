import{r as i,c as B,d as A,h as C,A as R}from"./switcher-007e3da1.js";const w="https://api.themoviedb.org/3/genre/movie/list",m="MY_LIBRARY";let p={},d=null,b=null;const O=await q(),h=O.data.genres;i.libraryContainer.addEventListener("click",$);function L(e){if(e.genres){const{poster_path:t,title:o,id:r,genres:n,release_date:s}=e,a=n.map(v=>v.name),c=s?s.split("-")[0]:"";return`

import{f as E,r as o,c as C,d as T,g as j}from"./switcher-a2a75825.js";var u=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function P(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var I=typeof u=="object"&&u&&u.Object===Object&&u,O=typeof self=="object"&&self&&self.Object===Object&&self;I||O||Function("return this")();const R=`
  .hero-text{
    max-height: 80px;
    max-width: 160px;
...
.hero-text-container {
  ...
  @media (min-device-pixel-ratio: 2),
...
}`;function H(e){return e>=9?"svg/star-desk-50.svg":e>=8?"svg/star-desk-45.svg":e>=7?"svg/star-desk-35.svg":e>=6?"svg/star-desk-30.svg":e>=5?"svg/star-desk-25.svg":e>=4?"svg/star-desk-20.svg":e>=3?"svg/star-desk-15.svg":e>=2?"svg/star-desk-10.svg":e>=1?"svg/star-desk-05.svg":"svg/star-desk-00.svg"}const q="https://image.tmdb.org/t/p/original/",n={trailerBackdrop:document.querySelector(".player_backdrop"),trailerContainer:document.querySelector(".player_container"),textContainer:document.querySelector(".hero-container"),trailerCloseBtn:document.querySelector("[data-modal-trailer-close]")},l="MY_LIBRARY";let p={},d=null,s=[],m=null;function b(e,t){return e=Math.ceil(e),t=Math.floor(t),Math.floor(Math.random()*(t-e+1)+e)}async function $(){try{if(s=await(await j("day")).data.results,m=b(0,s.length-1),s[m])n.textContainer.innerHTML=F(s[m]);else{n.textContainer.innerHTML=G();const t=document.createElement("style");t.innerHTML=R,document.head.appendChild(t)}}catch(e){console.error(e)}}function _(e){return`<iframe class="iframe_video_player" 
   ...
   <h1 class="text-modal-oops">
    ...
    <img class="star-rating-hero" src="${H(r)}" alt="raiting" />

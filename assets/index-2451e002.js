import{e as h,b as y,g as S,s as $}from"./switcher-d61c26e1.js";import"./catalog_hero-a25ae864.js";const g="MY_LIBRARY";let u={};async function w(){const e=await h();if(e.data.results.length===0){k();return}const t=Math.floor(Math.random()*e.data.results.length),s=e.data.results[t];B(s)}function k(){const e=document.getElementById("movies-container");e.innerHTML="<p>OOPS... We are very sorry!But we couldn’t find the film.</p>"}async function B(e){const t=e.genre_ids.map(d=>{const c=y.find(m=>m.id===d);return c?c.name:""}),{vote_average:s,vote_count:i,popularity:a,overview:r}=e,n=t.join(", "),p=document.getElementById("movies-container");p.innerHTML=`
  ...
  `,u=e;const o={addBtn:document.querySelector(".add-btn-home"),removeBtm:document.querySelector(".remove-btn-home")},l=v(g);l&&l.map(d=>{if(d.id===u.id){o.addBtn.classList.add("hide"),o.removeBtm.classList.remove("hide");return}}),o.addBtn.addEventListener("click",M),o.removeBtm.addEventListener("click",L)}function M(){const e={addBtn:document.querySelector(".add-btn-home"),removeBtm:document.querySelector(".remove-btn-home")},t=v(g);let s="",i=[];if(t){i=b(t);const n=JSON.stringify(i);s=O(n)}const a=JSON.stringify(u),r=R(a,s);e.addBtn.classList.toggle("hide"),e.removeBtm.classList.toggle("hide"),f(g,r)}function L(){const e={addBtn:document.querySelector(".add-btn-home"),removeBtm:document.querySelector(".remove-btn-home")},t=v(g);e.addBtn.classList.toggle("hide"),e.removeBtm.classList.toggle("hide");const s=b(t);f(g,s)}function b(e){return e.map(t=>{if(t.id!==u.id)return t}).filter(t=>t)}function v(e){try{const t=localStorage.getItem(e);return t===null?void 0:JSON.parse(t)}catch(t){console.error("Get state error: ",t.message)}}function f(e,t){try{const s=JSON.stringify(t);localStorage.setItem(e,s)}catch(s){console.error("Set state error: ",s.message)}}function O(e){return e.slice(1,e.length-1)}function R(e,t){return JSON.parse(t?`[${t}, ${e}]`:`[${e}]`)}function F(e){const t=new Date(e),s=t.getDate().toString().padStart(2,"0"),i=(t.getMonth()+1).toString().padStart(2,"0"),a=t.getFullYear();return`${s}.${i}.${a}`}function N(e){return Number(e).toFixed(1)}function j(e){return e.length>30?e.substring(0,30)+"...":e}function A(e){return e.length>420?e.substring(0,420)+"...":e}w();const H=document.querySelector(".weekly-js-list"),I=await S("week",1);H.innerHTML=await T(I.data.results.slice(0,3));async function T(e){const t=e.map(async({poster_path:i,title:a,genre_ids:r,id:n,release_date:p,vote_average:o})=>{const l=p.substr(0,4),d=q(y,r),c=Object.values(d),m=$(o);return`<li class="weekly-list">
    <img class="weekly-list-img" src="https://image.tmdb.org/t/p/original/${i}" alt="${a}" data-id="${n}" loading="lazy">
    ...
    <img class="weekly-list-img-tab tablet " src="https://image.tmdb.org/t/p/original/${i}" alt="${a}" data-id="${n}" loading="lazy">
    ...
    <img class="weekly-list-img-desc desktop" src="https://image.tmdb.org/t/p/original/${i}" alt="${a}" data-id="${n}" loading="lazy">
